...
describe("group day stats into day recap task", () => {
    ...
    it("groups short breaks into one recap task", () => {
        const data = [{
            ...
            stop: ["2020-07-13T11:26:04.102Z", "2020-07-13T11:29:04.102Z", "2020-07-13T11:36:04.102Z"]
        }];
    ...
    it("places a break recap task between two tasks", () => {
        const data = [
            ...
            {
                name: "test",
                start: ["2020-07-13T15:25:04.102Z"],
                stop: ["2020-07-13T16:26:04.102Z"]
            },
        ];
    ...
    it("sorts the tasks by time", () => {
        const data = [
            {
                name: "2",
                start: ["2020-07-13T12:25:04.102Z"],
            ...
            {
                name: "3",
                start: ["2020-07-13T13:25:04.102Z"],
    ...
    it("should handle a multi day task well", () => {
        const data = [
            {
                name: "test",
                start: ["2020-07-13T11:25:04.102Z", "2020-07-14T11:25:04.102Z", "2020-07-15T11:25:04.102Z"],
